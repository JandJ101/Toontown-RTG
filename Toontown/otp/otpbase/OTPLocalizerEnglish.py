...
GuiScreenToontownUnavailable = 'The background processes appear to be hanging. Hold on while we try to fix things up.'
...
CRConnecting = 'Loading game services...'
CRNoConnectTryAgain = 'The game was not loaded properly. Please exit Toontown completely and try again.'
...
CRNoDistrictsTryAgain = 'The game services have not finished loading yet. Please wait a moment, and click the blue check mark below.'
CRRejectRemoveAvatar = 'The avatar was not able to be deleted, try again another time.'
CRLostConnection = 'Uh-oh! The game has crashed un-expectedly. Check the log file for more information.'
CRBootedReasons = {1: 'An unexpected problem has occurred.  Your connection has been lost, but you should be able to connect again and go right back into the game.',
 100: 'The game is currently only playable in one window at a time. Multi-window support will be added later.',
 ...
 124: 'An unknown error has occured. Please submit your log file for this play session and try to load Toontown again.',
 ...
 153: 'Uh-Oh! The game services have crashed un-expectedly. Please wait a moment and re-load the game.',
...
CRBootedReasonUnknownCode = 'An unexpected problem has occurred (error code %s).  Your game services have crashed, but you should be able to re-load them and go right back into the game.'
CRTryConnectAgain = '\n\nReload now?'
CRToontownUnavailable = 'The game services appear to be hanging. Hang tight while we try to fix things up...'
...
FriendSecretIntro = "If you are playing Toontown with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
FriendSecretDetermineSecretAccountRollover = 'A friend across the network'
...
NCGeneric = 'Sorry, type-a-name has not been implemented yet. Please choose a name from the pre-generated name list.'
